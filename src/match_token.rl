...
%%{
    ...
    main := |*
        ...
        "EX.LOOP.REC"  => { MATCH_OP(E_OP_EX_LOOP_REC); };
        "EX.LOOP.PLAY" => { MATCH_OP(E_OP_EX_LOOP_PLAY); };
        "EX.LOOP.REV"  => { MATCH_OP(E_OP_EX_LOOP_REV); };
        "EX.LOOP.DOWN" => { MATCH_OP(E_OP_EX_LOOP_DOWN); };
        "EX.LOOP.CLR"  => { MATCH_OP(E_OP_EX_LOOP_CLR); };
        "EX.LOOP"      => { MATCH_OP(E_OP_EX_LOOP); };
