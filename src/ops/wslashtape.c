...
#define WS_ADDR (wslash_unit == 2 ? WS_T_ADDR_2 : WS_T_ADDR)

I2C_WRITE_8(op_WS_T_RECORD_write, WS_ADDR, WS_T_RECORD)
I2C_RECV_8(op_WS_T_RECORD_recv, WS_ADDR, WS_T_RECORD)
I2C_WRITE_8(op_WS_T_PLAY_write, WS_ADDR, WS_T_PLAY)
I2C_RECV_8(op_WS_T_PLAY_recv, WS_ADDR, WS_T_PLAY)
I2C_WRITE_0(op_WS_T_REV_write, WS_ADDR, WS_T_REV)
I2C_WRITE_16_16(op_WS_T_SPEED_write, WS_ADDR, WS_T_SPEED)
I2C_WRITE_16(op_WS_T_FREQ_write, WS_ADDR, WS_T_FREQ)
I2C_RECV_16(op_WS_T_FREQ_recv, WS_ADDR, WS_T_FREQ)
I2C_WRITE_16(op_WS_T_PRE_LEVEL_write, WS_ADDR, WS_T_PRE_LEVEL)
I2C_RECV_16(op_WS_T_PRE_LEVEL_recv, WS_ADDR, WS_T_PRE_LEVEL)
I2C_WRITE_16(op_WS_T_MONITOR_LEVEL_write, WS_ADDR, WS_T_MONITOR_LEVEL)
I2C_RECV_16(op_WS_T_MONITOR_LEVEL_recv, WS_ADDR, WS_T_MONITOR_LEVEL)
I2C_WRITE_16(op_WS_T_REC_LEVEL_write, WS_ADDR, WS_T_REC_LEVEL)
I2C_RECV_16(op_WS_T_REC_LEVEL_recv, WS_ADDR, WS_T_REC_LEVEL)
I2C_WRITE_8(op_WS_T_HEAD_ORDER_write, WS_ADDR, WS_T_HEAD_ORDER)
I2C_RECV_8(op_WS_T_HEAD_ORDER_recv, WS_ADDR, WS_T_HEAD_ORDER)
I2C_WRITE_0(op_WS_T_LOOP_START_write, WS_ADDR, WS_T_LOOP_START)
I2C_WRITE_0(op_WS_T_LOOP_END_write, WS_ADDR, WS_T_LOOP_END)
I2C_WRITE_8(op_WS_T_LOOP_ACTIVE_write, WS_ADDR, WS_T_LOOP_ACTIVE)
I2C_WRITE_8(op_WS_T_LOOP_SCALE_write, WS_ADDR, WS_T_LOOP_SCALE)
I2C_RECV_8(op_WS_T_LOOP_SCALE_recv, WS_ADDR, WS_T_LOOP_SCALE)
I2C_WRITE_8(op_WS_T_LOOP_NEXT_write, WS_ADDR, WS_T_LOOP_NEXT)
I2C_WRITE_16_16(op_WS_T_TIMESTAMP_write, WS_ADDR, WS_T_TIMESTAMP)
I2C_WRITE_16_16(op_WS_T_SEEK_write, WS_ADDR, WS_T_SEEK)
I2C_WRITE_0(op_WS_T_CLEARTAPE_write, WS_ADDR, WS_T_CLEARTAPE)
