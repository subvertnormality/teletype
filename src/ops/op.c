...
const tele_op_t *tele_ops[E_OP__LENGTH] = {
    ...
    // disting ex
    &op_EX_1, &op_EX_2, &op_EX_3, &op_EX_4, &op_EX_PRESET, &op_EX_PRE,
    &op_EX_SAVE, &op_EX_S, &op_EX_RESET, &op_EX_ALG, &op_EX_A, &op_EX_CTRL,
    &op_EX_C, &op_EX_PARAM, &op_EX_P, &op_EX_PV, &op_EX_MIN, &op_EX_MAX,
    &op_EX_REC, &op_EX_PLAY, &op_EX_AL_P, &op_EX_AL_CLK, &op_EX_M_CH,
    &op_EX_M_N, &op_EX_M_O, &op_EX_M_PB, &op_EX_M_CC, &op_EX_M_PRG,
    &op_EX_M_CLK, &op_EX_M_START, &op_EX_M_STOP, &op_EX_M_CONT, &op_EX_SB_CH,
    &op_EX_SB_N, &op_EX_SB_O, &op_EX_SB_PB, &op_EX_SB_CC, &op_EX_SB_PRG,
    &op_EX_SB_CLK, &op_EX_SB_START, &op_EX_SB_STOP, &op_EX_SB_CONT,
    &op_EX_VOX_P, &op_EX_VP, &op_EX_VOX, &op_EX_V, &op_EX_VOX_O, &op_EX_VO,
    &op_EX_NOTE, &op_EX_N, &op_EX_NOTE_O, &op_EX_NO, &op_EX_ALLOFF, &op_EX_AO,
