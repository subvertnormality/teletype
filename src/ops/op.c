...
const tele_op_t *tele_ops[E_OP__LENGTH] = {
    ...
    &op_G_LED_C, &op_G_REC, &op_G_BTN, &op_G_GBTN, &op_G_BTNX, &op_G_BTN_EN,
    &op_G_BTN_V, &op_G_BTN_L, &op_G_BTNI, &op_G_BTNV, &op_G_BTNL, &op_G_BTN_SW,
    &op_G_GBTN_V, &op_G_GBTN_L, &op_G_FDR, &op_G_GFDR, &op_G_FDRX, &op_G_FDR_EN,
    &op_G_FDR_V, &op_G_FDR_N, &op_G_FDR_L, &op_G_FDRI, &op_G_FDRV, &op_G_FDRN,
    &op_G_FDRL, &op_G_GFDR_V, &op_G_GFDR_N, &op_G_GFDR_L, &op_G_GFDR_RN,
    &op_G_XYP, &op_G_XYP_X, &op_G_XYP_Y
};
